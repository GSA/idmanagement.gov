...
| [Department of Homeland Security (DHS)](https://www.dhs.gov/){:target="_blank"}{:rel="noopener noreferrer"} | Oversees governmentwide and agency-specific cybersecurity implementation and reporting for information systems that fall under Federal Information Security Management Act (FISMA). <br><br> Provides adequate, risk-based, and cost-effective cybersecurity. |
...
| Human Resources (HR) | Collects information on federal employees. <br><br> Creates a digital identity for each employee within the agency’s Human Resources applications. |
