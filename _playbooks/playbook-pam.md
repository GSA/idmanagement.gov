...
- [**Functional privileged users**]({{site.baseurl}}/playbooks/dira/#step-1-identify-users-transactions-and-roles){:rel="noopener noreferrer"}{:class="usa-link"} can access information resources provided by the application and approval workflows, such as approving access requests.
