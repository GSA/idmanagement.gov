...
Many, but not all, software applications leverage the underlying operating system [trust store](../../trust-stores/) to verify whether a certificate should be trusted. 
...
Next, determine if you need to [distribute the CA certificates issued by the FCPCA G2](../certificates/).
