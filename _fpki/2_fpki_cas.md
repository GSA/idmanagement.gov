...
<p><img src="../../assets/fpki/intro_fbca-logo.png" alt="FPKI Federal Bridge Logo" style="float: left;" width="200" />The FBCA is a PKI Bridge or link between the FCPCA and other CAs that comprise the FPKI network and that may operate under comparable but _different_ certificate policies. The FBCA provides a means to map these certificate policies and CAs and allow certificates to validate to the FCPCA root certificate.</p>
