...
-	[**Card Conformance Tool (CCT)**](https://github.com/GSA/piv-conformance/releases){:rel="noopener noreferrer"}{:class="usa-link"} - a GSA managed Java tool which validates that Personal Identity Verification (PIV) and PIV-Interoperable (PIV-I) smart cards are compliant with key standards.
-	[**Certificate Profile Conformance Tool (CPCT)**](https://github.com/GSA/cpct-tool/releases/){:rel="noopener noreferrer"}{:class="usa-link"} - a web site application that analyzes certificates for conformance to a specific Federal PKI profile document version and certificate profile.
...
Email us at [fpki@gsa.gov](mailto:fpki@gsa.gov){:class="usa-link"}.
