...
Moving forward the updated certificate policy will be approved by the FPKIPA and published to [devicepki.idmanagement.gov](https://devicepki.idmanagement.gov/){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link usa-link--external"}, and will be announced here in the [FPKI Playbook Announcements]({{site.baseurl}}/fpki/announcements/), stay tuned.
