...
{% include alert-warning.html heading = "Prohibited Exceptions to SID Usage" content="Under no circumstances shall a Domain Controller auto-enrolled in ADCS for certificate issuance be identified in a policy tuple exception in GPO Allow name-based strong mappings for certificates. See Step 4 below regarding policy tuples. %}
