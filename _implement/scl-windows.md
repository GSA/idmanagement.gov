...
<div class="usa-alert usa-alert--error" role="alert">
  <div class="usa-alert__body">
    ...
    <p class="usa-alert__text">
      ...
      Agencies are encouraged to operate OCSP and CRL services via hostnames specifically reserved for those endpoints, so that other related information and functionality can be served securely and privately.
    </p>
  </div>
</div>
