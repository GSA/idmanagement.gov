...
1. On-Premise Smart Card Configuration
   1. [Windows Domains]({{site.baseurl}}/implement/trust-fcpca/){:class="usa-link"}
   2. [Windows Devices]({{site.baseurl}}/implement/scl-windows){:class="usa-link"}
   3. [MacOS Devices]({{site.baseurl}}/implement/scl-macos){:class="usa-link"}
   4. [SSH Command Line]({{site.baseurl}}/implement/scl-ssh/){:class="usa-link"}
   5. [Firefox Browser]({{site.baseurl}}/implement/scl-firefox){:class="usa-link"}
   6. [Microsoft Outlook]({{site.baseurl}}/implement/outlook){:class="usa-link"}
  
2. Cloud Certificate-based Authentication Configuration
   1. [Cloud or Hybrid-Joined Azure Entra ID]({{site.baseurl}}/implement/cba-azure/){:class="usa-link"}
   2. [Okta Yubikey Implementation Guide]({{site.baseurl}}/implement/yubikey-guide/){:class="usa-link"}

3. FIDO2 Configuration
   1. [Windows Hello for Business]({{site.baseurl}}/implement/whfb){:class="usa-link"}
...
1. Federal PKI Validation
   1. [FPKI Ecosystem Changes]({{site.baseurl}}/fpki/notifications){:class="usa-link"} - This page contains three distinct pages of information as well as an associated certificate bundle.
      1. [FPKI Graph]({{site.baseurl}}/fpki/notifications/#fpki-graph){:class="usa-link"} - The FPKI Graph displays the relationships between the certification authorities in the Federal PKI (FPKI) ecosystem.
      2. [PIV Issuer Information]({{site.baseurl}}/fpki/notifications/#piv-issuer-information){:class="usa-link"} - List of active PIV issuing CAs with end entity certificate distribution points.
      3. [FPKI System Change and Notification]({{site.baseurl}}/fpki/notifications/#notifications){:class="usa-link"} - List of changes to FPKI CA endpoint URL such as Certificate Revocation List Distribution Points, Online Certificate Status Protocol (OCSP) endpoints, and other CA certificate activity.
      4. [FPKI Certificate Bundle]({{site.baseurl}}/implement/tools/CACertificatesValidatingToFederalCommonPolicyG2.p7b){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link"} - A certificate bundle in .p7b format that contains all CA certificfates that chain to the Common Policy CA and can be viewed in the FPKI Graph.
   ...
   3. [FPKI Trust Infrastructure “HTTP.FPKI.Gov” URL Site Map (PDF, September 2022)]({{site.baseurl}}/docs/fpki-fpkima-sitemap.pdf){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link"} - A consolidated list of public repository information for FPKI resources.
...
If you don't find what you're looking for, open an [Issue]({{site.repourl}}/issues/new){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link"}.  We can help look through the archives of guides that haven't been posted yet or help you send a request to the government listserves.  

Your contributions are encouraged and welcome! You can [contribute]({{site.baseurl}}/contribute/){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link"} to this effort or open an [Issue]({{site.repourl}}/issues/new){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link"} to discuss a need you may have for a guide.
