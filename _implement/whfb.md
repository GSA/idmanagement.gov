...
<div class="usa-accordion usa-accordion--bordered">
  ...
  <h4 class="usa-accordion__heading">
    <button type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="b-a1">Where is the Windows Hello biometrics data stored?</button>
  </h4>
  <div id="b-a1" class="usa-accordion__content usa-prose">
  ...
  <h4 class="usa-accordion__heading">
    <button type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="b-a1">What happens when a user forgets their PIN?</button>
  </h4>
  <div id="b-a1" class="usa-accordion__content usa-prose">
  ...
  <h4 class="usa-accordion__heading">
    <button type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="b-a1">Can I disable the PIN while using Windows Hello for Business?</button>
  </h4>
  <div id="b-a1" class="usa-accordion__content usa-prose">
  ...
  <h4 class="usa-accordion__heading">
    <button type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="b-a1">How many users can enroll for Windows Hello for Business on a single Windows device?</button>
  </h4>
  <div id="b-a1" class="usa-accordion__content usa-prose">
  ...
  <h4 class="usa-accordion__heading">
    <button type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="b-a1">Can I use third-party MFA providers with Windows Hello for Business?</button>
  </h4>
  <div id="b-a1" class="usa-accordion__content usa-prose">
    <p>Yes, if you’re using federated hybrid deployment, you can use any third-party that provides an AD FS MFA adapter.</p>
  </div>
  <h4 class="usa-accordion__heading">
    <button type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="b-a1">Is Windows Hello for Business considered multi-factor authentication?</button>
  </h4>
  <div id="b-a1" class="usa-accordion__content usa-prose">
  ...
  <h4 class="usa-accordion__heading">
    <button type="button" class="usa-accordion__button" aria-expanded="false" aria-controls="b-a1">Can I use both a PIN and biometrics to unlock my device?</button>
  </h4>
  <div id="b-a1" class="usa-accordion__content usa-prose">
