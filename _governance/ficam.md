...
Members are appointed by each federal agency’s CIO, and the group operates under the authority of the Federal CIO Council through the Information Security and Identity Management Committee (ISIMC) and the Identity, Credential, and Access Management Subcommittee (ICAMSC). See the [FPKIPA Charter (PDF, February 2015)](../../docs/fpkipa-charter.pdf){:target="_blank"} for information on membership requirements, voting rights, etc. The FPKIPA meets in the morning on the second Tuesday of each month. Contact fpki at gsa.gov to participate in the FPKIPA or its working groups.
...
- [FPKIMA Newsletter – Volume 6, Issue 1 (PDF)](../../docs/fpki-fpkima-newsletter-61.pdf){:target="_blank"} 
- [FPKIMA Newsletter – Volume 5, Issue 4 (PDF)](../../docs/fpki-fpkima-newsletter-54.pdf){:target="_blank"} 
- [FPKIMA Newsletter – Volume 5, Issue 3 (PDF)](../../docs/fpki-fpkima-newsletter-53.pdf){:target="_blank"} 
