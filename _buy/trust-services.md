...
- Download the <a href="{{ site.basurl }}/_assets/docs/fpkitestguidev1-0.pdf">Testing Requirements and Guidelines for Commercial PKI Bridges Cross-Certified with the FBCA</a> [(PDF, December 2017)](../../_assets/docs/fpkitestguidev1-0.pdf).
