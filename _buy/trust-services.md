...
- Download the <a href="{{ site.baseurl }}/_assets/docs/fpkitestguidev1-0.pdf">Testing Requirements and Guidelines for Commercial PKI Bridges Cross-Certified with the FBCA</a> [(PDF, December 2017)](../../assets/docs/fpkitestguidev1-0.pdf).

Then, fill out the application contained in this document:

- Download the <a href="{{ site.baseurl }}/_assets/docs/fpkibridgeappprocessv1-1.pdf">FPKI Bridge Application Process Overview</a> (PDF, May 2017).
