...
| -------------- | ----------- | ------- | ---------------- |
| Federal Common Policy | [X.509 Certificate Policy for the U.S. FPKI Common Policy Framework v2.6]({{site.baseurl}}/docs/fpki-x509-cert-policy-common.pdf){:target="_blank"}{:rel="noopener noreferrer"} | [Common Policy X.509 Certificate and CRL Profiles v2.2]({{site.baseurl}}/docs/fpki-x509-cert-profile-common.pdf){:target="_blank"}{:rel="noopener noreferrer"}  | [Common Change Proposals]({{site.baseurl}}/fpki/#federal-pki-document-archive) |
| Federal Bridge | [X.509 Certificate Policy for the Federal Bridge Certification Authority (FBCA) v3.3]({{site.baseurl}}/docs/fpki-x509-cert-policy-fbca.pdf){:target="_blank"}{:rel="noopener noreferrer"} <br><br> and [PIV-I for Federal Agencies]({{site.baseurl}}/university/pivi/){:target="_blank"}{:rel="noopener noreferrer"} | [Federal Bridge Certification Authority (FBCA) X.509 Certificate and CRL Extensions Profile v2.0]({{site.baseurl}}/docs/fpki-x509-cert-profiles-fbca.pdf){:target="_blank"}{:rel="noopener noreferrer"} | [Bridge Change Proposals]({{site.baseurl}}/fpki/#federal-pki-document-archive) |
...
- FPKI Key Recovery Policy (October 2017) has been subsumed into the Common and Bridge policy documents as of 2021.
...
- PIV and PIV-I Annual Testing - supports FPKI Annual Reviews and can be done either in person at the GSA [FIPS 201 Lab]({{site.baseurl}}/fips201ep/#personal-identity-verification-credentials) or using available tools such as the [Card Conformance Tool (CCT) and Certificate Profile Conformance Tool (CPCT)]({{site.baseurl}}/fpki/#compliance-test-tools-for-annual-reviews)
...
- [U.S. FPKI Audit Letter of Compliance (PDF, October 2023)]({{site.baseurl}}/docs/fpki-fpkima-audit-letter.pdf){:target="_blank"}{:rel="noopener noreferrer"} – Results of the August 2022-August 2023 Compliance Audit for the FPKI Trust Infrastructure Systems.
