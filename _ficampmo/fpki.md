...
- PIV and PIV-I Annual Testing - supports FPKI Annual Reviews and can be done either in person at the GSA [FIPS 201 Lab]({{site.baseurl}}/fips201ep/#personal-identity-verification-credentials){:target="_blank"}{:rel="noopener noreferrer"} or using available tools such as the [Card Conformance Tool (CCT) and Certificate Profile Conformance Tool (CPCT)]({{site.baseurl}}/fpki/#compliance-test-tools-for-annual-reviews){:target="_blank"}{:rel="noopener noreferrer"}
