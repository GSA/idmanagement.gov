...
<ol class="usa-process-list">
  ...
  <ul class="usa-list">
    ...
    <li>Outputs generated by leveraging the following tools: 
      <ul class="usa-list">
        <li><svg class="usa-icon margin-right-3" aria-hidden="true" focusable="false" role="img"><use href="/assets/img/sprite.svg#credit_card"></use></svg><a class="usa-link usa-link--external" href="https://github.com/GSA/piv-conformance/releases" target="_blank">Card Conformance Tool (CCT)</a></li>
