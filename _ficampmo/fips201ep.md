      ...
      <p class="margin-bottom-2">Outputs generated by leveraging the following tools:</p>    
        <ul class="usa-icon-list">
          ...
          <li class="usa-icon-list__item">
            ...
            <div class="usa-icon-list__content">
              <a class="usa-link usa-link--external" href="https://csrc.nist.gov/News/2016/New-SP-800-73-4-based-Test-Runner-Release" target="_blank">SP 800-73-4-based Test Runner</a> <span class="usa-tag usa-tag--small"> (Optional) </span>
            </div>          
          </li>
        </ul>
      </div>
