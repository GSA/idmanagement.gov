...
<ol class="usa-process-list">
  ...
  <ul class="usa-list">
    <li>High-resolution front and back images of the PIV/PIV-I card being tested.</li>
    <li>Outputs generated by leveraging the following tools: 
      <ul class="usa-list">
        <li><svg class="usa-icon margin-right-3" aria-hidden="true" focusable="false" role="img"><use href="{{site.baseurl}}/assets/img/sprite.svg#credit_card"></use></svg><a class="usa-link usa-link--external" href="https://github.com/GSA/piv-conformance/releases" target="_blank">Card Conformance Tool (CCT)</a></li>
        <li><a class="usa-link usa-link--external" href="https://github.com/GSA/cpct-tool/releases/" target="_blank">Certificate Profile Conformance Tool</a></li>
        <li><a class="usa-link usa-link--external" href="https://github.com/grandamp/KSJavaAPI" target="_blank">KSJavaAPI</a></li>
        <li><a class="usa-link usa-link--external" href="https://csrc.nist.gov/News/2016/New-SP-800-73-4-based-Test-Runner-Release" target="_blank">SP 800-73-4-based Test Runner</a>(Optional)</li>
      </ul>
    </li>
   </ul>
  </li>
