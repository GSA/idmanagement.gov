...
- [PACS Functional Requirements and Test Cases Guidance Document v1.4.2 Rev. C (PDF, November 30, 2023)]({{site.baseurl}}/docs/fips201ep-pacsfrtc.pdf){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link"}
    - [PACS Test Card User Guide]({{site.baseurl}}/docs/pacstest-testuserguide.pdf){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link"} (PDF, January 2019)
...
<ol class="usa-process-list">
  ...
  <li class="usa-process-list__item">
  <p class="margin-bottom-2">All applicants must provide the following required artifacts as part of the Annual PCI review:</p>
  <ul class="usa-icon-list">
    ...
    <li class="usa-icon-list__item">
      <div class="usa-icon-list__icon">
        <svg class="usa-icon" aria-hidden="true" role="img"><use href="{{site.baseurl}}/assets/img/sprite.svg#settings"></use></svg>
      </div>
      <div class="usa-icon-list__content">
      <p class="margin-bottom-2">Outputs generated by leveraging the following tools:</p>    
        <ul class="usa-icon-list">
          <li class="usa-icon-list__item">
            <div class="usa-icon-list__icon">
            ...
            <div class="usa-icon-list__content">
              <a class="usa-link usa-link--external" href="https://github.com/GSA/piv-conformance/releases" target="_blank">Card Conformance Tool (CCT)</a>
            </div>
          </li>
          <li class="usa-icon-list__item">
            <div class="usa-icon-list__icon">
            ...
            <div class="usa-icon-list__content">
              <a class="usa-link usa-link--external" href="https://github.com/GSA/cpct-tool/releases/" target="_blank">Certificate Profile Conformance Tool</a>
            </div>          
          </li>
          <li class="usa-icon-list__item">
            <div class="usa-icon-list__icon">
            ...
            <div class="usa-icon-list__content">
              <a class="usa-link usa-link--external" href="https://github.com/grandamp/KSJavaAPI" target="_blank">KSJavaAPI</a>
            </div>          
          </li>
          <li class="usa-icon-list__item">
            <div class="usa-icon-list__icon">
            ...
            <div class="usa-icon-list__content">
              <a class="usa-link usa-link--external" href="https://csrc.nist.gov/News/2016/New-SP-800-73-4-based-Test-Runner-Release" target="_blank">SP 800-73-4-based Test Runner</a> <span class="badge text-bg-secondary">(Optional)</span>
            </div>          
          </li>
        </ul>
      </div>
...
<ol class="usa-process-list">
  ...
  <li class="usa-process-list__item">
  <h4 class="usa-process-list__heading">
  <svg class="usa-icon" aria-hidden="true" focusable="false" role="img"><use href="{{site.baseurl}}/assets/img/sprite.svg#local_library"></use></svg>&nbsp;&nbsp;Complete PACS Test Card Loaner Set Request Form</h4>
  ...
  <li class="usa-process-list__item">
  <h4 class="usa-process-list__heading">
  <svg class="usa-icon" aria-hidden="true" focusable="false" role="img"><use href="{{site.baseurl}}/assets/img/sprite.svg#local_library"></use></svg>&nbsp;&nbsp;Pre-Paid Shipping Box Address</h4>
  ...
  <li class="usa-process-list__item">
  <h4 class="usa-process-list__heading">
  <svg class="usa-icon" aria-hidden="true" focusable="false" role="img"><use href="{{site.baseurl}}/assets/img/sprite.svg#local_library"></use></svg>&nbsp;&nbsp;Use the Loaner Set to Complete the FRTC</h4>
  ...
  <li class="usa-process-list__item">
  <h4 class="usa-process-list__heading">
  <svg class="usa-icon" aria-hidden="true" focusable="false" role="img"><use href="{{site.baseurl}}/assets/img/sprite.svg#local_library"></use></svg>&nbsp;&nbsp;Vendor Returns the PACS Loaner Set of Cards</h4>
  ...
  <li class="usa-process-list__item">
  <h4 class="usa-process-list__heading">
  <svg class="usa-icon" aria-hidden="true" focusable="false" role="img"><use href="{{site.baseurl}}/assets/img/sprite.svg#local_library"></use></svg>&nbsp;&nbsp;Program Performs QA on the Returned Loaner Set of Cards</h4>
