...
<ol class="usa-process-list">
  ...
  <p>All applicants must provide the following required artifacts as part of the Annual PCI review:</p>
  <ul class="usa-icon-list">
    ...
    <li class="usa-icon-list__item">
      ...
      <div class="usa-icon-list__content">
      <p>Outputs generated by leveraging the following tools:</p>    
        <ul class="usa-icon-list">
          <li class="usa-icon-list__item">
            <div class="usa-icon-list__icon">
