...
<ol class="usa-process-list">
  ...
  <ul class="usa-list">
    ...
    <li>Outputs generated by leveraging the following tools: <a class="usa-link usa-link--external" href="https://github.com/GSA/piv-conformance/releases" target="_blank">Card Conformance Tool (CCT)</a>, <a class="usa-link usa-link--external" href="https://github.com/GSA/cpct-tool/releases/" target="_blank">Certificate Profile Conformance Tool</a>, <a class="usa-link usa-link--external" href="https://github.com/grandamp/KSJavaAPI" target="_blank">KSJavaAPI</a>, and the <a class="usa-link usa-link--external" href="https://csrc.nist.gov/News/2016/New-SP-800-73-4-based-Test-Runner-Release" target="_blank">SP 800-73-4-based Test Runner</a>(Optional).</li>
   </ul>
  </li>
</ol>
