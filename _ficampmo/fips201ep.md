...
4. List the equipment used for the APL testing in the equipment table linked here – [Equipment Table GSA PACS Application v0.3.0 (MS Excel, August 2024)]({{site.baseurl}}/docs/equipment-table-gsa-pacs-application.xlsx){:target="_blank"}{:rel="noopener noreferrer"}(Mandatory).


[Equipment Table GSA PACS Application v0.2.0 (MS Excel, November 2023)](/docs/equipment-table-gsa-pacs-application.xlsx) (Mandatory).  
