...
1. [541519CSP](https://www.gsaelibrary.gsa.gov/ElibMain/sinDetails.do?scheduleNumber=MAS&specialItemNumber=541519CSP&executeQuery=YES){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link usa-link--external"} – Credential Service Provider  
2. [541519PKI](https://www.gsaelibrary.gsa.gov/ElibMain/sinDetails.do?executeQuery=YES&scheduleNumber=MAS&flag=&filter=&specialItemNumber=541519PKI){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link usa-link--external"} – Public Key Infrastructure (PKI) Shared Service Providers (PKI SSP)  
3. [541519ICAM](https://www.gsaelibrary.gsa.gov/ElibMain/sinDetails.do?scheduleNumber=MAS&specialItemNumber=541519ICAM&executeQuery=YES){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link usa-link--external"} – Identity, Credential, and Access Management Solutions  
4. [541519PIV](https://www.gsaelibrary.gsa.gov/ElibMain/sinDetails.do?scheduleNumber=MAS&specialItemNumber=541519PIV&executeQuery=YES){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link usa-link--external"} – HSPD-12 Products and Service Components

Please contact [fpki@gsa.gov](mailto:fpki@gsa.gov){:class="usa-link"} if you have questions related to professional services.
...
- [541519CSP](https://www.gsaelibrary.gsa.gov/ElibMain/sinDetails.do?scheduleNumber=MAS&specialItemNumber=541519CSP&executeQuery=YES){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link usa-link--external"} - Credential Service Provider (CSP), Managed service offering for component or full-service Credential Service Providers (CSPs) that meet the requirements of NIST SP 800-63 Digital Identity Guidelines (current version), to include public-facing and enterprise. The provided capabilities [template]({{site.baseurl}}/docs/credential-service-provider-capabilities-template-feb-2025.docx){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link"} must be thoroughly completed. Below is a list of relevant documents.  
  - [Homeland Security Presidential Directive 12 (HSPD-12)](https://www.dhs.gov/homeland-security-presidential-directive-12){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link usa-link--external"}.

  - [National Institute of Standards and Technology (NIST) Special Publication (SP) 800-63](https://pages.nist.gov/800-63-3/){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link usa-link--external"}.

  - [NIST Federal Information Processing Standard (FIPS) 201: Personal Identity Verification (PIV) of Federal Employees and Contractors](https://csrc.nist.gov/publications/detail/fips/201/3/final){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link usa-link--external"}.


- [541519PKI](https://www.gsaelibrary.gsa.gov/ElibMain/sinDetails.do?executeQuery=YES&scheduleNumber=MAS&flag=&filter=&specialItemNumber=541519PKI){:target="_blank"}{:rel="noopener noreferrer"}{:class="usa-link usa-link--external"} - Public Key Infrastructure (PKI) Shared Service Providers (PKI SSP) Program - PKI SSPs shall provide reliable, authenticated, policy-compliant service offerings to support Federally issued Personal Identity Verification (PIV), Personal Identity Verification Interoperable (PIV-I), and associated certificates and cryptographic key service offerings.
...
GSA certifies consulting services and labor categories through Special Item Numbers (SIN) for ICAM or HSPD-12 professional services. Please contact [fpki@gsa.gov](mailto:fpki@gsa.gov){:class="usa-link"} if you have questions related to professional services.
