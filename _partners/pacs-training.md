...
The next section, [Lessons Learned]({{site.baseurl}}/partners/lessonslearned/), shares lessons learned from various federal agencies on planning, procurement, operations, and training.
