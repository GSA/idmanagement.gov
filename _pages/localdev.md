...
Click on the big green <span style="background-color:#29903b;color:#FFFFFF;padding-left:5px;padding-right:5px;border-radius:5px;margin-right:5px;">   < > Code </span>  button or clone the repo if you are familiar with the using Git on the command line.
