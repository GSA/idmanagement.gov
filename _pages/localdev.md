...
Click on the big green <span style="background-color: #29903b;color:#FFFFFF;padding-left:4px;padding-right:4px;border-radius:5px;"> <> Code </span> button or clone the repo if you are familiar with the using Git on the command line.
