...
## Who receives a PIV credential?
A PIV credential is a **physical and digital credential**. Only some people are eligible, though. The [OPM credentialing standards](https://www.opm.gov/suitability/suitability-executive-agent/policy/cred-standards.pdf){:target="_blank"}{:rel="noopener noreferrer"} outlines two primary criteria to qualify for a PIV credential.
1. Physical or logical access is required for six months or more. Agencies should consider the benefits of PIV eligibility for intermittent or temporary employees who may need repeated access over multiple years.
2. Performing work for or on behalf of a federal government department or agency.

A PIV credential is issued after an agency completes an eligibility determination. To the maximum extent practicable, agencies must align PIV eligibility determinations with other personnel vetting determinations made by a trained federal adjudicator. Individuals making PIV eligibility determinations must be investigated and adjudicated at a level commensurate with the position's responsibilities as determined by applying the Position Designation System. As it pertains to “authorization,” the position designation quantifies risk and sensitivity, making it the most critical factor in establishing that bridge between identity and access. The new investigative standards align well with FISMA rankings for low, moderate, and high for system access and [Interagency Security Committee rankings](https://www.dhs.gov/sites/default/files/publications/ISC_Risk-Management-Process_Aug_2013_0.pdf){:target="_blank"}{:rel="noopener noreferrer"} rankings of low to very high for facility access.

If someone doesn't qualify for a PIV, an agency can look for an alternative credential like a [PIV Interoperable credential]({{site.baseurl}}//university/pivi/) or an [alternative authenticator]({{site.baseurl}}/playbooks/altauthn/).
