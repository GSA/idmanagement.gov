...
A PIV credential is **physical and digital credential**. Only some people are eligible though. The [OPM credentialing standards](https://www.opm.gov/suitability/suitability-executive-agent/policy/cred-standards.pdf){:target="_blank"}{:rel="noopener noreferrer"} outlines two primary criteria to qualify for a PIV credential.
