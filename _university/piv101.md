...
A PIV credential is a **physical and digital credential**, but someone has to meet specific criteria to receive one. The [OPM credentialing standards](https://www.opm.gov/suitability/suitability-executive-agent/policy/cred-standards.pdf){:target="_blank"}{:rel="noopener noreferrer"} outlines procedures departments and agencies must use to determine PIV eligibility which at it's most basic level is those needing physical or logical access to Federally controlled facilities and/or Federal IT systems for six months or more. The following communities of users are required to go through a PIV suitability determination: 
...
Short-term communities of users who will require physical or logical access to federally controlled facilities or Federal IT systems for less than six months are not subject to this standard. Departments and agencies should determine their suitability determination requirements in a local policy for these individuals. The local policy may be to submit the individual to a PIV suitability determination to manage risk better; it is not required. For these short-term workers, departments and agencies may select an alternative authenticator like a [PIV Interoperable credential]({{site.baseurl}}//university/pivi/) or an [alternative authenticator]({{site.baseurl}}/playbooks/altauthn/) after their local process provides a favorable determination.
