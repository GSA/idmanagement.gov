...
Short-term workers requiring physical or logical access to federally controlled facilities or Federal IT systems for less than six months are not subject to this OPM standard. Departments and agencies should document short-term worker suitability determination requirements in a local policy. An agency's local policy may be to submit the individual to a PIV suitability determination to manage risk better, but it is not required. After a favorable determination of a short-term worker, departments and agencies may issue an alternative authenticator like a [PIV Interoperable credential]({{site.baseurl}}//university/pivi/) or an [alternative authenticator]({{site.baseurl}}/playbooks/altauthn/).
