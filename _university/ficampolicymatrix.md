...
{% assign guidance_authority = site.data.laws-policies-standards | where: "type", "Authority" | where: shortName != policies.shortName | where: shortName != document.shortName %}
