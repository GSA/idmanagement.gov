(function () {
  ...
  function TabbedHeader(root) {
    ...
    this.defaultInterval = validInterval(root.dataset.defaultInterval, 10);
  ...
  TabbedHeader.prototype.schedule = function () {
    ...
    var seconds = validInterval(this.tabs[this.activeIndex].dataset.intervalSeconds, this.defaultInterval);
  ...
  TabbedHeader.prototype.updateToggle = function () {
    ...
    var actionLabel = isOn ? "Stop" : "Start";
