...
3. Provide the equipment table from the Approved Product List Application as a separate file. [Equipment Table GSA PACS Application v0.1 (XLSX, February 2023)]({{site.baseurl}}/docs/equipment-table-gsa-pacs-application-v0.1.xlsx){:target="_blank"}{:rel="noopener noreferrer"}
